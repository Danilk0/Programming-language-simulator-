...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label2->Text = L"Введение в C++";
			// 
			// textBox1
			// 
			...
			this->pictureBox2->Click += gcnew System::EventHandler(this, &MyForm8::pictureBox2_Click);
			// 
			// label3
			// 
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(571, 350);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(31, 350);
...
#pragma endregion
		...
		void DataChange(int id) {
			...
			OleDbConnection^ dbConnection = gcnew OleDbConnection(connectionString);
			dbConnection->Open();
			String^ query1 = "SELECT Label, TextBox FROM [C++] WHERE Код = " + id;
			OleDbCommand^ dbCommand1 = gcnew OleDbCommand(query1, dbConnection);
